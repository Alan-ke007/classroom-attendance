...
-- 计科2101 (大四，课较少，但分布合理)
('编译原理', (SELECT id FROM user WHERE username = 'zhanglaoshi'), 1, '教学楼A301', '08:00', '09:40', '周一', NOW()),
('编译原理', (SELECT id FROM user WHERE username = 'zhanglaoshi'), 1, '教学楼A301', '10:00', '11:40', '周三', NOW()),
('软件工程', (SELECT id FROM user WHERE username = 'zhanglaoshi'), 1, '教学楼A302', '14:00', '15:40', '周二', NOW()),
('软件工程', (SELECT id FROM user WHERE username = 'zhanglaoshi'), 1, '教学楼A302', '16:00', '17:40', '周四', NOW()),
('人工智能导论', (SELECT id FROM user WHERE username = 'lilaoshi'), 1, '实验楼B101', '08:00', '09:40', '周五', NOW()),

-- 计科2201 (大二，核心专业课密集)
('数据结构', (SELECT id FROM user WHERE username = 'zhanglaoshi'), 2, '教学楼A201', '08:00', '09:40', '周一', NOW()),
('数据结构', (SELECT id FROM user WHERE username = 'zhanglaoshi'), 2, '教学楼A201', '10:00', '11:40', '周三', NOW()),
('计算机网络', (SELECT id FROM user WHERE username = 'lilaoshi'), 2, '教学楼A202', '08:00', '09:40', '周二', NOW()),
('计算机网络', (SELECT id FROM user WHERE username = 'lilaoshi'), 2, '教学楼A202', '14:00', '15:40', '周五', NOW()),
('Java程序开发', (SELECT id FROM user WHERE username = 'lilaoshi'), 2, '实验楼B201', '10:00', '11:40', '周四', NOW()),
('Java程序开发', (SELECT id FROM user WHERE username = 'lilaoshi'), 2, '实验楼B201', '16:00', '17:40', '周四', NOW()),
('数据库原理', (SELECT id FROM user WHERE username = 'zhanglaoshi'), 2, '教学楼A203', '14:00', '15:40', '周一', NOW()),
('数据库原理', (SELECT id FROM user WHERE username = 'zhanglaoshi'), 2, '教学楼A203', '08:00', '09:40', '周三', NOW()),
('Web前端开发', (SELECT id FROM user WHERE username = 'wanglaoshi'), 2, '实验楼B202', '16:00', '17:40', '周二', NOW()),

-- 软工2201 (大二，理论与实践结合)
('软件测试', (SELECT id FROM user WHERE username = 'wanglaoshi'), 3, '教学楼B301', '08:00', '09:40', '周一', NOW()),
('软件测试', (SELECT id FROM user WHERE username = 'wanglaoshi'), 3, '实验楼C101', '14:00', '15:40', '周三', NOW()),
('Linux系统管理', (SELECT id FROM user WHERE username = 'wanglaoshi'), 3, '实验楼C102', '10:00', '11:40', '周二', NOW()),
('软件项目管理', (SELECT id FROM user WHERE username = 'wanglaoshi'), 3, '教学楼B302', '08:00', '09:40', '周四', NOW()),
('软件项目管理', (SELECT id FROM user WHERE username = 'wanglaoshi'), 3, '教学楼B302', '10:00', '11:40', '周五', NOW()),
('移动应用开发', (SELECT id FROM user WHERE username = 'lilaoshi'), 3, '实验楼C101', '16:00', '17:40', '周一', NOW()),
('移动应用开发', (SELECT id FROM user WHERE username = 'lilaoshi'), 3, '实验楼C101', '16:00', '17:40', '周四', NOW()),
('云计算技术', (SELECT id FROM user WHERE username = 'lilaoshi'), 3, '教学楼B303', '14:00', '15:40', '周五', NOW()),

-- 软工2202 (大二，与2201部分共享教师)
('软件测试', (SELECT id FROM user WHERE username = 'wanglaoshi'), 4, '教学楼B301', '10:00', '11:40', '周一', NOW()),
('软件测试', (SELECT id FROM user WHERE username = 'wanglaoshi'), 4, '实验楼C101', '16:00', '17:40', '周三', NOW()),
('Linux系统管理', (SELECT id FROM user WHERE username = 'wanglaoshi'), 4, '实验楼C102', '14:00', '15:40', '周二', NOW()),
('软件项目管理', (SELECT id FROM user WHERE username = 'wanglaoshi'), 4, '教学楼B302', '14:00', '15:40', '周四', NOW()),
('软件项目管理', (SELECT id FROM user WHERE username = 'wanglaoshi'), 4, '教学楼B302', '08:00', '09:40', '周五', NOW()),
('移动应用开发', (SELECT id FROM user WHERE username = 'lilaoshi'), 4, '实验楼C102', '08:00', '09:40', '周二', NOW()),
('设计模式', (SELECT id FROM user WHERE username = 'lilaoshi'), 4, '教学楼B303', '10:00', '11:40', '周四', NOW()),
('设计模式', (SELECT id FROM user WHERE username = 'lilaoshi'), 4, '教学楼B303', '16:00', '17:40', '周五', NOW()),

-- 人工智能2301 (大二上，课业繁重)
('高等数学A2', (SELECT id FROM user WHERE username = 'zhanglaoshi'), 5, '教学楼C401', '08:00', '09:40', '周一', NOW()),
('高等数学A2', (SELECT id FROM user WHERE username = 'zhanglaoshi'), 5, '教学楼C401', '08:00', '09:40', '周三', NOW()),
('高等数学A2', (SELECT id FROM user WHERE username = 'zhanglaoshi'), 5, '教学楼C401', '10:00', '11:40', '周五', NOW()),
('机器学习', (SELECT id FROM user WHERE username = 'zhanglaoshi'), 5, '教学楼C402', '10:00', '11:40', '周一', NOW()),
('机器学习', (SELECT id FROM user WHERE username = 'zhanglaoshi'), 5, '教学楼C402', '14:00', '15:40', '周四', NOW()),
('深度学习', (SELECT id FROM user WHERE username = 'lilaoshi'), 5, '教学楼C403', '08:00', '09:40', '周二', NOW()),
('深度学习', (SELECT id FROM user WHERE username = 'lilaoshi'), 5, '实验楼D101', '16:00', '17:40', '周二', NOW()),
('自然语言处理', (SELECT id FROM user WHERE username = 'lilaoshi'), 5, '实验楼D101', '14:00', '15:40', '周三', NOW()),
('计算机视觉', (SELECT id FROM user WHERE username = 'zhanglaoshi'), 5, '实验楼D102', '10:00', '11:40', '周四', NOW()),
('Python科学计算', (SELECT id FROM user WHERE username = 'lilaoshi'), 5, '教学楼C404', '19:00', '20:40', '周三', NOW()),

-- 大数据2201 (大二，核心专业课)
('大数据技术基础', (SELECT id FROM user WHERE username = 'lilaoshi'), 6, '教学楼D501', '08:00', '09:40', '周一', NOW()),
('大数据技术基础', (SELECT id FROM user WHERE username = 'lilaoshi'), 6, '教学楼D501', '10:00', '11:40', '周四', NOW()),
('Hadoop生态系统', (SELECT id FROM user WHERE username = 'lilaoshi'), 6, '实验楼E101', '10:00', '11:40', '周二', NOW()),
('Hadoop生态系统', (SELECT id FROM user WHERE username = 'lilaoshi'), 6, '实验楼E101', '14:00', '15:40', '周五', NOW()),
('Spark流计算', (SELECT id FROM user WHERE username = 'lilaoshi'), 6, '教学楼D502', '14:00', '15:40', '周一', NOW()),
('Spark流计算', (SELECT id FROM user WHERE username = 'lilaoshi'), 6, '实验楼E101', '16:00', '17:40', '周三', NOW()),
('数据可视化', (SELECT id FROM user WHERE username = 'wanglaoshi'), 6, '实验楼E102', '08:00', '09:40', '周三', NOW()),
('数据挖掘', (SELECT id FROM user WHERE username = 'lilaoshi'), 6, '教学楼D503', '16:00', '17:40', '周四', NOW()),

-- 网工2101 (大三，专业课 + 实践)
('网络工程', (SELECT id FROM user WHERE username = 'zhanglaoshi'), 7, '教学楼F601', '08:00', '09:40', '周一', NOW()),
('网络工程', (SELECT id FROM user WHERE username = 'zhanglaoshi'), 7, '教学楼F601', '10:00', '11:40', '周三', NOW()),
('网络安全', (SELECT id FROM user WHERE username = 'zhanglaoshi'), 7, '教学楼F602', '14:00', '15:40', '周二', NOW()),
('网络安全', (SELECT id FROM user WHERE username = 'zhanglaoshi'), 7, '教学楼F602', '16:00', '17:40', '周四', NOW()),
('路由交换技术', (SELECT id FROM user WHERE username = 'wanglaoshi'), 7, '实验楼G101', '10:00', '11:40', '周五', NOW()),
('路由交换技术', (SELECT id FROM user WHERE username = 'wanglaoshi'), 7, '实验楼G101', '14:00', '15:40', '周五', NOW()),
('网络攻防实践', (SELECT id FROM user WHERE username = 'wanglaoshi'), 7, '实验楼G102', '08:00', '09:40', '周四', NOW());
...
SELECT
  ...
  (SELECT id FROM user WHERE username = 'zhanglaoshi'),
...
((SELECT id FROM user WHERE username = 'zhanglaoshi'), 'leave', '新的请假申请', '学生周明提交了请假申请，请及时审批', 0, NULL, NOW()),
((SELECT id FROM user WHERE username = 'zhanglaoshi'), 'system', '版本更新通知', '系统已更新至 V1.1，新增二维码签到和通知功能', 1, NULL, DATE_SUB(NOW(), INTERVAL 2 DAY)),
((SELECT id FROM user WHERE username = 'lilaoshi'), 'attendance', '考勤异常提醒', '软件工程2201班今日有2名学生缺勤', 0, NULL, NOW()),
((SELECT id FROM user WHERE username = 'wanglaoshi'), 'behavior', '行为预警提醒', '您的课程中检测到学生异常行为，请查看详情', 1, NULL, DATE_SUB(NOW(), INTERVAL 1 DAY)),
((SELECT id FROM user WHERE username = 'teststudent'), 'system', '欢迎使用智课考勤', '您好，欢迎使用智课考勤系统！请完善您的个人资料', 1, NULL, DATE_SUB(NOW(), INTERVAL 3 DAY));
